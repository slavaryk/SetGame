...
final class CheckSelectedCardsTests: XCTestCase {
	...
	func testInvalidCardsCount() {
		...
		XCTAssertEqual(result, false, "Should return false if invalid cards amount given")
	}
    ...
    func testNotInSetCards() throws {
        replaceCardInTestableCards(with: SetGame.Card(
            ...
            quantity: SetGame.Quantity.three
        ), at: 1)
